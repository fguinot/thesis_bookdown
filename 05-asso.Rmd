...
relevance such as non-synonymous polymorphisms[^1], splice-site
variants[^2], and copy number polymorphisms (CNP[^3]). One the other
...
widely used to identify causal genomic variants[^4] implied in the
...
```{r qqplot, echo=FALSE, fig.cap='(ref:qqplot)', out.width='60%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/qqplot_example.png")
```
...
```{r penetrancetabfig, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/penetrance_tab.png")
```
...
```{r contingencytabfig, echo=FALSE, fig.align="center", out.width='90%'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/contingency_tab.png")
```
...
```{r penetrancefig, echo=FALSE, fig.cap='(ref:penetrancefig)', out.width='75%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/penetrance.jpg")
```
...
```{r SNPcodefig, echo=FALSE, out.width='75%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/SNPcode.png")
```
...
software [@pritchard2000inference], uses an admixture model[^5] where
...
-   The weighted identity by state (IBS[^6]) kernel:
...
associations located in non-coding region[^7] are set aside.
...
[^1]: A non-synonymous SNP is a SNP that modifies the protein sequence
    in opposition to a synonymous SNP.

[^2]: A genetic alteration in the DNA sequence that occurs at the
...
[^3]: A CNP is a normal variation in DNA due to the varying number of
...
[^4]: In the remainder of the paper, the terms variant, marker, locus,
    SNP or polymorphism will equivalently refer to the variable studied
    in GWAS.

[^5]: An admixture model is a statistical model taking in account the
    phenomenon known as population admixture (see Section
    \@ref(#originLD)).

[^6]: A DNA segment is identical by state (IBS) in two or more
    individuals if they have identical nucleotide sequences in this
    segment.

[^7]: Non-coding DNA (formerly referred as ’junk’ DNA) represents 99$\%$
