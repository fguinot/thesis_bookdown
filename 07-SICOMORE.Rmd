...
plants, the role of rhizosphere[^1] microflora on plant growth is well
known and has been widely studied
[@mukerji2002techniques; @pinton2007rhizosphere].

Analysis equivalent to GWAS have been conducted using the metagenome[^2]
...
indexed with $i$, such as $\mathbf{x}_i$, will usually be row vectors[^3] while
...
In shotgun metagenomics,[^5] microorganisms are studied by sequencing
...
```{r hierarchy, echo=FALSE, fig.cap='(ref:hierarchy)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/hierarchy.png")
```
...
```{r X, echo=FALSE, fig.cap='(ref:X)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/X.png")
```
...
```{r tabconfusionfig, echo=FALSE, fig.align="center", out.width='50%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_confusion.png")
```
...
```{r ggheatheta, echo=FALSE, fig.cap='(ref:ggheatheta)', out.width='90%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/ggheat_theta.png")
```
...
```{r theta2by2, echo=FALSE, fig.cap='(ref:theta2by2)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/theta2by2.png")
```
...
```{r precisionBONF, echo=FALSE, fig.cap='(ref:precisionBONF)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/precision_simureal_BONF-3.png")
```

(ref:recallBONF) Boxplots of recall for each couple of parameters $N$ (in rows) and $\epsilon$ (in columns) for $I=7$.

```{r recallBONF, echo=FALSE, fig.cap='(ref:recallBONF)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/precision_simureal_BONF-3.png")
```
...
```{r tabcomptimefig, echo=FALSE, fig.align="center", out.width='50%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_confusion.png")
```
...
```{r histopheno, echo=FALSE, fig.cap='(ref:histopheno)', out.width='100%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/histo_pheno_INRA.png")
```
...
```{r piechart1, echo=FALSE, fig.cap='(ref:piechart1)', out.width='80%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/piechart1.png")
```
...
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/cowplot_heatmap_chr4_17448921-chr4_22706884.png")
```
...
```{r tabBMtotfig, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_biomass.png")
```
...
```{r tabresBMtotfig, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_resBMtot.png")
```
...
```{r tabRTRfig, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_RTR.png")
```
...
```{r tabresRTR1, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_resRTR1.png")
```      
      
2.  Option 4 (phylogenetic clustering on Metagenomic data and subset of SNP data):

```{r tabresRTR2, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_resRTR2.png")
```  

### Results on Specific Nitrogen Uptake

```{r tabSNUfig, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_SNU.png")
```
...
```{r tabresSNU, echo=FALSE, fig.align="center", out.width='80%',fig.asp=.75}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/tab_resSNU.png")
```  
...
```{r piechart2, echo=FALSE, fig.cap='(ref:piechart2)', out.width='70%',fig.asp=.75, fig.align='center'}
knitr::include_graphics("/Users/fguinot/Documents/bioptilamme/Manuscript/figures/piechart2.png")
```
...
[^1]: The rhizosphere is the term used to describe the zone of intense
...
[^2]: The metagenome corresponds to all the genetic material present in
    an environmental sample, consisting of the genomes of many
    individual organisms.

[^3]: For the sake of clarity, we use these lightened notations which
    slightly differ from those used in the previous chapters.

[^4]: To our knowledge, their implementation based on alternating
    direction method of multipliers is not publicly available.

[^5]: see Section \@ref(DNAseq) for details on shotgun sequencing.
