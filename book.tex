...
\begin{center}\includegraphics[width=1\linewidth]{book_files/figure-latex/1ere-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{book_files/figure-latex/dna-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/sanger-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/pyro-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/genomeassembly-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{book_files/figure-latex/snp-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{book_files/figure-latex/microarray-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/drift-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/LDhaploview-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/haploprop-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/haplostructure-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{book_files/figure-latex/qqplot-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{book_files/figure-latex/penetrancetabfig-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{book_files/figure-latex/contingencytabfig-1} \end{center}
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/penetrancefig-1} 
...
\begin{center}\includegraphics[width=0.75\linewidth]{book_files/figure-latex/SNPcodefig-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/penciltrick-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/step2-1} 
...
\begin{center}\includegraphics[width=0.7\linewidth]{book_files/figure-latex/algocutlevel-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/AUCcurvesimu-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/scatterperfsimu-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/histomaf-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/WTCCC-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/spondy-1} 
...
\begin{center}\includegraphics[width=0.6\linewidth]{book_files/figure-latex/markerdensityfig-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/ggheat-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/manhattanspondy-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/qqplotWTCCC-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/AUCgam-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/manhattangam-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/fittedgamspondy-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/hierarchy-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/X-1} 
...
\begin{center}\includegraphics[width=0.5\linewidth]{book_files/figure-latex/tabconfusionfig-1} \end{center}
...
{\centering \includegraphics[width=0.9\linewidth]{book_files/figure-latex/ggheatheta-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/theta2by2-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/precisionBONF-1} 
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/recallBONF-1} 
...
\begin{center}\includegraphics[width=0.5\linewidth]{book_files/figure-latex/tabcomptimefig-1} \end{center}
...
{\centering \includegraphics[width=1\linewidth]{book_files/figure-latex/histopheno-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/piechart1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{book_files/figure-latex/heatmapchr4-1} 
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabBMtotfig-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabresBMtotfig-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabRTRfig-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabresRTR1-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabresRTR2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabSNUfig-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{book_files/figure-latex/tabresSNU-1} \end{center}
...
{\centering \includegraphics[width=0.7\linewidth]{book_files/figure-latex/piechart2-1} 
...
& = Var(\hat{f}) + \sigma^2 + \mathbb{E}^2_\mathcal{T}(\mathrm{Y}) + \mathbb{E}^2_\mathcal{T}(\hat{f}) - 2\mathbb{E}(f)\mathbb{E}_\mathcal{T}(\hat{f}) \\
