...
\hypersetup{unicode=true,
            pdftitle={Statistical learning for omics association and interactions studies based on blockwise feature compression},
            pdfauthor={Florent Guinot},
            pdfborder={0 0 0},
            breaklinks=true}
...
\addcontentsline{toc}{subsection}{Problematic}
...
\addcontentsline{toc}{subsection}{Contents of the manuscript}
