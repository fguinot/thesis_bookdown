...
-   **Non-parametric methods:** These approaches do not make explicit
    ...
    regression splines and the generalized additive model[^1].
...
```{r algo_backfitting, echo=FALSE, fig.align='center', fig.asp=.75, out.width='100%'}
...
```{r algo_CAH, echo=FALSE, fig.align='center', fig.asp=.75, out.width='100%'}
...
```{r algo_HCAR, echo=FALSE, fig.align='center', fig.asp=.75, out.width='100%'}
...
[^1]: To be more specific, we will present the semi-parametric forms of
