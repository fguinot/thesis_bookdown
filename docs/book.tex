...
\begin{center}\includegraphics{book_files/figure-latex/1ere-1} \end{center}
...
{\centering \includegraphics[width=0.08\linewidth]{book_files/figure-latex/haplostructure-1} 
